...
.footer {
  ...
  margin-top: 20px;
  text-align: center;
}`, "",{"version":3,"sources":["webpack://./src/css/style.css"],"names":[],"mappings":"AAAA;EACE,8BAA8B;EAC9B,yBAAyB;EACzB,SAAS;EACT,UAAU;EACV,aAAa;EACb,sBAAsB;EACtB,uBAAuB;EACvB,mBAAmB;EACnB,aAAa;AACf;;AAEA;EACE,YAAY;EACZ,aAAa;EACb,kBAAkB;EAClB,mBAAmB;EACnB,aAAa;EACb,eAAe;AACjB;;AAEA;EACE,kBAAkB;EAClB,MAAM;EACN,OAAO;EACP,QAAQ;EACR,SAAS;EACT,UAAU;AACZ;;AAEA;EACE,kBAAkB;EAClB,MAAM;EACN,OAAO;EACP,QAAQ;EACR,SAAS;EACT,sBAAsB;EACtB,aAAa;EACb,uBAAuB;EACvB,mBAAmB;EACnB,kBAAkB;EAClB,uBAAuB;EACvB,wCAAwC;AAC1C;;AAEA;EACE,sBAAsB;EACtB,yBAAyB;AAC3B;;AAEA;EACE,YAAY;EACZ,YAAY;EACZ,aAAa;EACb,mBAAmB;EACnB,aAAa;EACb,kBAAkB;EAClB,aAAa;EACb,wCAAwC;EACxC,sBAAsB;AACxB;;AAEA;EACE,gBAAgB;EAChB,sBAAsB;EACtB,kBAAkB;EAClB,aAAa;EACb,wCAAwC;EACxC,YAAY;AACd;;AAEA;EACE,eAAe;EACf,mBAAmB;EACnB,kBAAkB;AACpB;;AAEA;EACE,qBAAqB;EACrB,UAAU;EACV,SAAS;AACX;;AAEA;EACE,aAAa;EACb,8BAA8B;EAC9B,mBAAmB;EACnB,mBAAmB;EACnB,eAAe;AACjB;;AAEA;EACE,cAAc;EACd,qBAAqB;EACrB,iBAAiB;EACjB,eAAe;AACjB;;AAEA;EACE,0BAA0B;AAC5B;;AAEA;EACE,eAAe;EACf,WAAW;EACX,gBAAgB;EAChB,kBAAkB;AACpB","sourcesContent":["body {\n  font-family: Arial, sans-serif;\n  background-color: #f9f9f9;\n  margin: 0;\n  padding: 0;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n}\n\n.converter_cont {\n  width: 500px;\n  height: 100px;\n  position: relative;\n  margin-bottom: 20px;\n  padding: 20px;\n  cursor: pointer;\n}\n\n.overlapped {\n  position: absolute;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  opacity: 0;\n}\n\n.overlap {\n  position: absolute;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  background-color: #fff;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  border-radius: 8px;\n  border: 1px dashed #ccc;\n  box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);\n}\n\n.overlap:hover {\n  border: 1px solid #ccc;\n  background-color: #f7f7f7;\n}\n\n#res {\n  resize: none;\n  width: 500px;\n  height: 100px;\n  margin-bottom: 20px;\n  padding: 20px;\n  border-radius: 8px;\n  outline: none;\n  box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);\n  border: 1px solid #ccc;\n}\n\n.container {\n  background: #fff;\n  border: 1px solid #ccc;\n  border-radius: 8px;\n  padding: 20px;\n  box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);\n  width: 500px;\n}\n\n.container h1 {\n  font-size: 16px;\n  margin-bottom: 20px;\n  text-align: center;\n}\n\n.file-list {\n  list-style-type: none;\n  padding: 0;\n  margin: 0;\n}\n\n.file-list li {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 10px;\n  font-size: 14px;\n}\n\n.file-list a {\n  color: #007BFF;\n  text-decoration: none;\n  font-weight: bold;\n  cursor: pointer;\n}\n\n.file-list a:hover {\n  text-decoration: underline;\n}\n\n.footer {\n  font-size: 12px;\n  color: #555;\n  margin-top: 20px;\n  text-align: center;\n}"],"sourceRoot":""}]);
// Exports
...
var downloadedSizeElement = document.getElementById("downloaded-size");
var fileContainer = document.querySelector(".converter_cont");
var fileInput = document.querySelector("#pdf-file-input");
var textArea = document.querySelector("#res");
var totalDownloaded = 0;
links.forEach(function (link) {
  var dataUrl = link.getAttribute("data-file");
  var base64String = dataUrl.split(",")[1];
  var fileSizeInBytes = base64String.length * (3 / 4) - (base64String.endsWith("==") ? 2 : base64String.endsWith("=") ? 1 : 0);
  var fileSizeInMb = fileSizeInBytes / (1024 * 1024);
  var fileSizeElement = link.previousElementSibling;
  fileSizeElement.textContent = "".concat(fileSizeInMb.toFixed(2), " Mb");
  link.addEventListener("click", function (event) {
    event.preventDefault();
    var fileName = link.previousElementSibling.previousElementSibling.textContent.trim().replace(/\s+/g, "_") + ".pdf";
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 11:
          ...
          textArea.value = "";
          textArea.value = _context.t0.message;
          console.error("Ошибка при обработке файла:", _context.t0.message);
        case 16:
        case "end":
